...
_TOPICS: dict[str, _Topic] = {
    ...
    "transforms": _Topic(
        ...
        body=(
            ...
            "  map          Persist a value->masked map across runs. Like hash but human-readable.\n"
            "               Backing types: faker, hash, fixed.\n"
    ...
    "pipeline": _Topic(
        ...
        body=(
            ...
            "  mappings           store_directory -- where map-type transforms persist.\n"

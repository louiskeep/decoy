...
_TOPICS: dict[str, _Topic] = {
    ...
    "transforms": _Topic(
        ...
        body=(
            ...
            "  map          Deterministically replace values without a local mapping file.\n"
            "               Backing types: faker, hash, fixed, manual.\n"
    ...
    "pipeline": _Topic(
        ...
        body=(
            ...
            "  mappings           optional; only categorical mapping workflows should persist here.\n"
    ...
    "keys": _Topic(
        ...
        body=(
            ...
            "within one run, but the mapping is not portable across machines or pipelines.\n\n"
